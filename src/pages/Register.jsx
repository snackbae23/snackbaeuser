...
const Register = () => {
  ...
  const verifyEmail = (e) => {
    ...
    let config = {
      ...
      url: "https://goldfish-app-yhaxv.ondigitalocean.app/api/verify-otp",
      headers: {
...
const requestOtp = async (e) => {
  ...
  let config = {
    method: "post",
    maxBodyLength: Infinity,
    url: "https://goldfish-app-yhaxv.ondigitalocean.app/api/check-email-existence",
    headers: {
      "Content-Type": "application/json",
    },
  ...
  try {
    ...
    if (response.data.exists ===false) {
      let sendOtpConfig = {
        method: "post",
        maxBodyLength: Infinity,
        url: "https://goldfish-app-yhaxv.ondigitalocean.app/api/send-otp",
        headers: {
          "Content-Type": "application/json",
        },
        data: { email: formData.email },
